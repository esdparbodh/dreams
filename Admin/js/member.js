...
// Countries
var country_arr = new Array("Master Distributor", "Distributor", "Retailer");
// States
var s_a = new Array();
s_a[0]="";
s_a[1]="";
s_a[2]="ESWORLD UTILITY SERVICES|dist";
s_a[3]="ESWORLD AGENT|RTADMIN-SIDI";
...
function populateCountries(countryElementId, stateElementId){
	...
	countryElement.options[0] = new Option('Select Member','-1');
